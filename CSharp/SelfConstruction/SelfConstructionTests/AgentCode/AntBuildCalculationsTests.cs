...
namespace SelfConstructionTests.AgentCode
{
    ...
    public class AntBuildCalculationsTests
    {
        ...
        public void GetSortedPheromoneInfluencesTest()
        {
            ...
            List<Pheromone> returnValue = antBuildCalculations.GetSortedPheromoneInfluences(GlobalKnowledge.Instance, new Agent(new Position(0, 0, 0)));
        ...
        public void ShouldBuildTest()
        {
            ...
            Assert.IsTrue(pheromoneModel.ShouldBuild(GlobalKnowledge.Instance, new Agent(new Position(0, 0, 0))),
